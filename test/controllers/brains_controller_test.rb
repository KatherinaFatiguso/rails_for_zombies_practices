...
class BrainsControllerTest < ActionController::TestCase
  ...
  test "should create brain" do
    assert_difference('Brain.count') do
      post :create, brain: { flavour: @brain.flavour, status: @brain.status, zombie_id: @brain.zombie_id }
    end
  ...
  test "should update brain" do
    patch :update, id: @brain, brain: { flavour: @brain.flavour, status: @brain.status, zombie_id: @brain.zombie_id }
    assert_redirected_to brain_path(assigns(:brain))
  end
